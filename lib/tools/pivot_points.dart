...
// Ads here
                        ...
                        builder: (context) {
                          return AlertDialog(
                            ...
                            content: Container(
                              ...
                              child: _formResultList(result, index, width),
                            ),
                          );
                        },
                      );
  ...
  _formResultList(Map<String, double> result, int index, double width) {
    switch (index) {
      case 2:
        //  results for spp
        return ListView(
          children: [
            ...
            resultListTile(
                title: 'Resistance 2',
                subtitle: result['r2'].toStringAsFixed(2)),
            resultListTile(
                title: 'Resistance 1',
                subtitle: result['r1'].toStringAsFixed(2)),

            resultListTile(
                title: 'Pivot Point', subtitle: result['p'].toStringAsFixed(2)),
            resultListTile(
                title: 'Support 1', subtitle: result['s1'].toStringAsFixed(2)),
            resultListTile(
                title: 'Support 2', subtitle: result['s2'].toStringAsFixed(2))
          ],
        );
        break;
      case 3:
// result for fibo pp
        return ListView(
          children: [
            ...
            resultListTile(
                title: 'Resistance 3 : ',
                subtitle: result['r3'].toStringAsFixed(2)),
            resultListTile(
                title: 'Resistance 2 : ',
                subtitle: result['r2'].toStringAsFixed(2)),
            resultListTile(
            ...
            resultListTile(
                title: 'Pivot Point : ',
                subtitle: result['p'].toStringAsFixed(2)),
            resultListTile(
                title: 'Support 1 : ',
                subtitle: result['s1'].toStringAsFixed(2)),
            resultListTile(
                title: 'Support 2 : ',
                subtitle: result['s2'].toStringAsFixed(2)),
            resultListTile(
                title: 'Support 3 : ',
                subtitle: result['r3'].toStringAsFixed(2)),
          ],
      ...
      case 4:
        ...
        return ListView(
          children: [
            resultListTile(
                title: 'Resistance 4 : ',
                subtitle: result['r4'].toStringAsFixed(2)),
            resultListTile(
                title: 'Resistance 3 : ',
                subtitle: result['r3'].toStringAsFixed(2)),
            resultListTile(
            ...
            resultListTile(
                title: 'Support 4 : ',
                subtitle: result['s4'].toStringAsFixed(2)),
          ],
        );
        break;
      case 5:
      ...
      case 6:
        ...
        return ListView(
          children: [
            ...
            resultListTile(
                title: 'Support 3 : ',
                subtitle: result['s3'].toStringAsFixed(2)),
          ],
        );
        break;
    }
